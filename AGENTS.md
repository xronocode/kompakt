...
## Keywords
pdf-compression, cli, ghostscript, pypdf, python, desktop, terminal, offline, open-source

## Annotation
Kompakt — free, private, offline PDF compression desktop CLI. Python-based terminal wizard with fuzzy file search, quality selection (low/medium/high), and dual-engine compression (Ghostscript primary, pypdf fallback). Ships as standalone binaries for macOS, Linux, Windows via PyInstaller.
